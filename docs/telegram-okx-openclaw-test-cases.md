...
| `TC-TOP-003` | operator commands | none | Run `python3 scripts/smoke_operator.py --config config.demo.local.json` | local/Web small Claw help/status/readiness/paths/channels/signals/risk/positions/orders/pause/resume/reconcile/topic-test/close flows are handled | JSON smoke output | existing |
