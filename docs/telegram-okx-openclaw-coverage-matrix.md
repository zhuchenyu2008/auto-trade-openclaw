...
| `RQ-12` | small Claw operator surface | `Runtime.run_operator_command`, watcher operator routing | implemented | `scripts/smoke_operator.py`, operator unit tests | `TC-TOP-003` | inbound readiness still depends on bot token plus topic wiring |
